...
\begin{frame}
  ...
  \end{itemize}
  % \todo plot of normalized and unnormalized Gaussian\\
  % \todo plot of sampling grids
  \begin{columns}
    \begin{column}{0.33\textwidth}
      \adjustbox{width=0.008\textwidth}{
        \begin{tikzpicture}[remember picture,overlay]
          \node[xshift=4cm,yshift=3cm] at (current page.south west) {\tikz \pic{normal_normalized_unnormalized};};
        \end{tikzpicture}}
    \end{column}
